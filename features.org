...
** IN-PROGRESS UI [7/13]
   ...
   8. [ ] Download the actual songs
   9. [ ] Fix the TreeView disappearing bug
   10. [ ] Empty model on search call
   11. [ ] Add button to flip artist and song name.
   12. [ ] Async search with spinners and (maybe) threads
   13. [ ] More to come...
